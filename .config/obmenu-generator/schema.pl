...
our $SCHEMA = [
    ...
    #          COMMAND                 LABEL              ICON
    {item => ['xdg-open http://', 'Web Browser']},
    {item => ['alacritty',        'Terminal']},
    {item => ['java -jar /opt/RuneLite/RuneLite.jar --mode=OFF',        'RuneLite']},
    {item => ['discord',          'Discord']},
    {item => ['thunar .',         'Files']},
    {item => ['scrot "%Y-%m-%d_$wx$h.png" -e "mv $f ~/Pictures/"',            'Screen Shot']},
    ...
    {item => ['~/.utility/lock', 'Lock', 'system-lock-screen']},
